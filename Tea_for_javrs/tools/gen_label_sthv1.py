...
if __name__ == '__main__':
    dataset_name = 'my-dataset'  # 'jester-v1'
    ...
    for (filename_input, filename_output) in zip(files_input, files_output):
        ...
        for i in range(len(folders)):
            ...
            dir_files = os.listdir(os.path.join(r'E:\tea-action-recognition-master\datasets\my_dataset_frame', curFolder))
            output.append('%s %d %d' % ('datasets/my-dataset_frame/' + curFolder, len(dir_files), curIDX))
