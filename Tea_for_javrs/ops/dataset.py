...
class TSNDataSet(data.Dataset):
    ...
    def __init__(
            ...
            image_tmpl='img_{:06d}.jpg', transform=None, random_shift=True,
            test_mode=False, remove_missing=False, multi_clip_test=False,
            dense_sample=False,root_path=''):
    ...
    def _parse_list(self):
       ...
       #print(self.list_file)
        now =os.path.join(r"/opt/ml/job/ops",self.list_file)
        tmp = [x.strip().split(' ') for x in open(now)]
...
if __name__ == "__main__":
    # test dataset
    test_train_list =r'/opt/ml/job/ops/val_videofolder.txt'
    test_num_segments = 8
    data_length = 1
    test_modality = 'RGB'
    prefix = '{:06d}.jpg'
