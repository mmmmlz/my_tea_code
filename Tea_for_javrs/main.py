...
def main():
   ...
   # import pdb; pdb.set_trace()
    ...
    if args.resume:
        ...
        log_training = open(os.path.join(args.output_dir,args.root_log, args.store_name,
            'log.csv'), 'w')
        with open(os.path.join(args.output_dir,args.root_log, args.store_name,
            'args.txt'), 'w') as f:
            f.write(str(args))
...
def save_checkpoint(state, is_best):
    ...
    filename = '%s/%s/%s/ckpt.pth.tar' % (args.output_dir, args.root_model, args.store_name)
...
def check_rootfolders():
    ...
    folders_util = [args.root_log, args.root_model,args.output_dir,
os.path.join(args.output_dir,args.root_log),
os.path.join(args.output_dir,args.root_model),
os.path.join(args.output_dir, args.root_model, args.store_name),
os.path.join(args.output_dir,args.root_log,args.store_name),
